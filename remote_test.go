...
import (
	...
	"github.com/mybee/selenium/chrome"
	"github.com/mybee/selenium/firefox"
	"github.com/mybee/selenium/log"
	"github.com/mybee/selenium/sauce"
)
...
func TestDocker(t *testing.T) {
	...
	// passed to go test.
	cmd := exec.Command("docker", "run", fmt.Sprintf("--volume=%s:/code", pathToMount), "--workdir=/code/src/github.com/mybee/selenium", "go-selenium", "testing/docker-test.sh")
	if testing.Verbose() {
