...
[![GoDoc](https://godoc.org/github.com/mybee/selenium?status.svg)](https://godoc.org/github.com/mybee/selenium)
[![Travis](https://travis-ci.org/tebeka/selenium.svg?branch=master)](https://travis-ci.org/tebeka/selenium)
[![Go Report Card](https://goreportcard.com/badge/github.com/mybee/selenium)](https://goreportcard.com/report/github.com/mybee/selenium)
...
Run
    ...
    go get -t -d github.com/mybee/selenium
...
The API documentation is at https://godoc.org/github.com/mybee/selenium. See
[the example](https://github.com/mybee/selenium/blob/master/example_test.go)
and
[the unit tests](https://github.com/mybee/selenium/blob/master/remote_test.go)
...
[issue]: https://github.com/mybee/selenium/issues/new
...
[issues]: https://github.com/mybee/selenium/issues
...
For debugging Docker directly, run the following commands:
    ...
    $ docker run --volume=${GOPATH?}:/code --workdir=/code/src/github.com/mybee/selenium -it go-selenium bash
